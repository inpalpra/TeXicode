parent_dependent_type_dict = {
    ...
    ("cmd_xarr",  ("symb", "[")):  "opn_xblw",
    ("opn_xblw",  ("symb", "]")):  "cls_xblw",
...
type_dict = {
    ...
    ("cmnd", "overset"): "cmd_ovst",
    ("cmnd", "underset"): "cmd_undst",
    ("cmnd", "stackrel"): "cmd_ovst",
    ("cmnd", "overbrace"): "cmd_ovbrc",
    ("cmnd", "underbrace"): "cmd_unbrc",
    ...
    ("cmnd", "boxed"): "cmd_boxd",
    ("cmnd", "color"): "cmd_colr",
    ("cmnd", "textcolor"): "cmd_colr",
    ("cmnd", "cancel"): "cmd_cncl",
    ("cmnd", "bcancel"): "cmd_cncl",
    ("cmnd", "colorbox"): "cmd_cbox",
...
type_info_dict = {
    ...
    "cmd_ovst":  ((False, []),
                  ...
                  (True, True, []),
                  (True, False, False),
                  (False, "render_overset")),
    "cmd_undst": ((False, []),
                  (2,),
                  (True, True, []),
                  (True, False, False),
                  (False, "render_underset")),
    "cmd_ovbrc": ((False, []),
                  (1,),
                  (True, True, []),
                  (True, False, False),
                  (False, "render_overbrace")),
    "cmd_unbrc": ((False, []),
                  (1,),
                  (True, True, []),
                  (True, False, False),
                  (False, "render_underbrace")),
    "cmd_xarr":  ((False, ["opn_xblw",]),
                  (1,),
                  (True, True, []),
                  (True, False, False),
                  (True, "render_xarrow")),
